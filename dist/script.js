...
var modals = function modals() {
  function bindModal(triggerSelectror, modalSelectror, closeSelector) {
    var trigger = document.querySelectorAll(triggerSelectror),
...
var tabs = function tabs(headerSelector, tabSelector, contentSelector, activeClass) {
  ...
  function showTabContent(argument) {
    content[argument].style.display = 'block';
    tab[argument].classList.add(activeClass);
  }
